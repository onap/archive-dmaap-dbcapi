...
public class AAFAuthorizationFilter implements Filter{
    ...
    private static final String AAF_AUTHZ_FLAG = "UseAAF";
    private static final String API_NS_PROP = "ApiNamespace";
    private static final String DEFAULT_API_NS = "org.onap.dmaap-bc.api";
    private static final String BOOT_INSTANCE = "boot";
