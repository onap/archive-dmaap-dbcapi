...
public class ApiPolicyTest {
    ...
    @Test
    public void getUseAuthClass_shouldReturnTrueForValidApiPermClass() {
        properties.put("ApiPermission.Class", "org.onap.dmaap.dbcapi.authentication.ApiPolicyTest$DummyApiAuthorization");
        apiPolicy = new ApiPolicy(properties);

        assertTrue(apiPolicy.getUseAuthClass());
    }

    @Test
    public void getUseAuthClass_shouldReturnFalseWhenPropertyIsNotSet() {
        apiPolicy = new ApiPolicy(properties);

        assertFalse(apiPolicy.getUseAuthClass());
    }

    @Test
    public void getUseAuthClass_shouldReturnFalseWhenWrongClassIsSet() {
